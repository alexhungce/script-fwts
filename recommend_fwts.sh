...
RECOMMEND_TESTS="version cpufreq maxfreq msr mtrr nx virt aspm dmicheck apicedge klog oops uefibootpath uefirtvariable uefirttime uefirtmisc --acpitests --log-level=high"
